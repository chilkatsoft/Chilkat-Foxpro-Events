uploadEventHandler = CREATEOBJECT("MyUploadEvents")
loUpload = CreateObject("Chilkat_9_5_0.Upload")
EVENTHANDLER(loUpload,uploadEventHandler)

DEFINE CLASS MyUploadEvents AS SESSION OLEPUBLIC
