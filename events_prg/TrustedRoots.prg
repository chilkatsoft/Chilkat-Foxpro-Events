trustedRootsEventHandler = CREATEOBJECT("MyTrustedRootsEvents")
loTrustedRoots = CreateObject("Chilkat_9_5_0.TrustedRoots")
EVENTHANDLER(loTrustedRoots,trustedRootsEventHandler)

DEFINE CLASS MyTrustedRootsEvents AS SESSION OLEPUBLIC
