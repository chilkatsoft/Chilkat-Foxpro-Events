compressionEventHandler = CREATEOBJECT("MyCompressionEvents")
loCompression = CreateObject("Chilkat_9_5_0.Compression")
EVENTHANDLER(loCompression,compressionEventHandler)

DEFINE CLASS MyCompressionEvents AS SESSION OLEPUBLIC
