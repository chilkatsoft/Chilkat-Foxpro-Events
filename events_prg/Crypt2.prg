crypt2EventHandler = CREATEOBJECT("MyCrypt2Events")
loCrypt2 = CreateObject("Chilkat_9_5_0.Crypt2")
EVENTHANDLER(loCrypt2,crypt2EventHandler)

DEFINE CLASS MyCrypt2Events AS SESSION OLEPUBLIC
