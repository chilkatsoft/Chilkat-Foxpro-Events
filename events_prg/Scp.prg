scpEventHandler = CREATEOBJECT("MyScpEvents")
loScp = CreateObject("Chilkat_9_5_0.Scp")
EVENTHANDLER(loScp,scpEventHandler)

DEFINE CLASS MyScpEvents AS SESSION OLEPUBLIC
