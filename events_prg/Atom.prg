atomEventHandler = CREATEOBJECT("MyAtomEvents")
loAtom = CreateObject("Chilkat_9_5_0.Atom")
EVENTHANDLER(loAtom,atomEventHandler)

DEFINE CLASS MyAtomEvents AS SESSION OLEPUBLIC
