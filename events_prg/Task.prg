taskEventHandler = CREATEOBJECT("MyTaskEvents")
loTask = CreateObject("Chilkat_9_5_0.Task")
EVENTHANDLER(loTask,taskEventHandler)

DEFINE CLASS MyTaskEvents AS SESSION OLEPUBLIC
