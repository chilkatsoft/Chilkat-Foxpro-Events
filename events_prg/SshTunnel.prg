sshTunnelEventHandler = CREATEOBJECT("MySshTunnelEvents")
loSshTunnel = CreateObject("Chilkat_9_5_0.SshTunnel")
EVENTHANDLER(loSshTunnel,sshTunnelEventHandler)

DEFINE CLASS MySshTunnelEvents AS SESSION OLEPUBLIC
