spiderEventHandler = CREATEOBJECT("MySpiderEvents")
loSpider = CreateObject("Chilkat_9_5_0.Spider")
EVENTHANDLER(loSpider,spiderEventHandler)

DEFINE CLASS MySpiderEvents AS SESSION OLEPUBLIC
