streamEventHandler = CREATEOBJECT("MyStreamEvents")
loStream = CreateObject("Chilkat_9_5_0.Stream")
EVENTHANDLER(loStream,streamEventHandler)

DEFINE CLASS MyStreamEvents AS SESSION OLEPUBLIC
IMPLEMENTS _IChilkatEvents IN "Chilkat_9_5_0.Stream"
