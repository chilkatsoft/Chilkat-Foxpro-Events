authGoogleEventHandler = CREATEOBJECT("MyAuthGoogleEvents")
loAuthGoogle = CreateObject("Chilkat_9_5_0.AuthGoogle")
EVENTHANDLER(loAuthGoogle,authGoogleEventHandler)

DEFINE CLASS MyAuthGoogleEvents AS SESSION OLEPUBLIC
