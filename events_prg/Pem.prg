pemEventHandler = CREATEOBJECT("MyPemEvents")
loPem = CreateObject("Chilkat_9_5_0.Pem")
EVENTHANDLER(loPem,pemEventHandler)

DEFINE CLASS MyPemEvents AS SESSION OLEPUBLIC
