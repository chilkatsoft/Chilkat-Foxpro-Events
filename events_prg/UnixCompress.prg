unixCompressEventHandler = CREATEOBJECT("MyUnixCompressEvents")
loUnixCompress = CreateObject("Chilkat_9_5_0.UnixCompress")
EVENTHANDLER(loUnixCompress,unixCompressEventHandler)

DEFINE CLASS MyUnixCompressEvents AS SESSION OLEPUBLIC
