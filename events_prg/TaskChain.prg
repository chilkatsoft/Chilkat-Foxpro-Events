taskChainEventHandler = CREATEOBJECT("MyTaskChainEvents")
loTaskChain = CreateObject("Chilkat_9_5_0.TaskChain")
EVENTHANDLER(loTaskChain,taskChainEventHandler)

DEFINE CLASS MyTaskChainEvents AS SESSION OLEPUBLIC
